      ...
      <section className="py-12 md:py-16 bg-[#f5f1eb]/50">
        <div className="container">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-[#405862] mb-8 flex items-center">
            ...
            <div className="space-y-3">
              {[
                {
                  q: "What is the Simmon Chang Chess Club?",
                ...
                {
                  q: "Who was Simmon Chang?",
                  a: "Simmon Chang was an extraordinarily passionate chess player and a courageous fighter who passed away from osteosarcoma. His dream was to encourage children facing similar battles and to inspire people to work hard and never give up. With his family's permission, the club was renamed in his honour. His motto was: “Be your own kings and queens.”",
                },
                {
                  q: "Where do the tournament proceeds go?",
                  a: "100% of tournament entry fees and donations are given to the Pediatric Cancer Research Foundation through the Dr. Interested fundraiser page. PCRF funds pediatric cancer research and provides scholarships and support for cancer patients and their families.",
                },
                {
                  q: "Are the tournaments CFC-rated?",
                  a: "Yes. Our rated events are submitted to the Chess Federation of Canada for rating. You will need a CFC ID to have your games rated; players from anywhere are welcome to take part.",
                },
                {
                ...
                <details
                  key={item.q}
                  className="group bg-white border border-[#405862]/10 rounded-lg p-5 shadow-sm"
                >
                  <summary className="flex cursor-pointer list-none items-center justify-between font-semibold text-[#405862]">
                    {item.q}
                    <span className="ml-4 text-[#4ecdc4] transition-transform group-open:rotate-45">+</span>
                  </summary>
                  <p className="mt-3 text-[#405862]/80 leading-relaxed">{item.a}</p>
                </details>
              ))}
            </div>
          </div>
