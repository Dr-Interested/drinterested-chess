  ...
  return (
    <div className="container py-16 max-w-4xl">
      ...
      <div className="bg-[#405862] text-white p-6 rounded-lg mb-8 shadow-md">
        ...
        <p className="text-center mb-0">How the Simmon Chang Chess Club uses artificial intelligence tools.</p>
      </div>
      ...
      <div className="space-y-8 bg-white p-8 rounded-lg shadow-md">
        <section>
          ...
          <p className="text-slate-600">
            This policy explains how the Dr. Interested Simmon Chang Chess (Against Cancer) Club uses artificial
            intelligence (AI) tools in producing content, building and maintaining this website, and supporting our
            operations, and the limits we place on that use. It applies alongside our{" "}
        ...
        <section>
          ...
          <ul className="list-disc pl-6 mt-2 space-y-1 text-slate-600">
            <li>Drafting, editing, and researching website copy, event recaps, and announcements</li>
            <li>Building and maintaining this website and the tools our team uses internally</li>
            <li>Summarizing, organizing, or formatting information (for example, tournament results or documentation)</li>
            <li>General administrative and operational support</li>
          </ul>
          <p className="text-slate-600 mt-4">
            AI-assisted content is reviewed by a member of our team before it is published. AI tools support our work;
            they do not publish on our behalf without human review, they do not run tournaments, and they do not make
            decisions about individual people (such as fair-play rulings or pairings) on our behalf.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-slate-600">
            Regardless of whether a piece of content was written with AI assistance, everything published by the club
            is for informational purposes only and is not medical, legal, financial, or career advice. See our{" "}
            <Link href="/terms" className="text-[#405862] font-medium underline hover:text-[#4ecdc4]">
              Terms and Conditions
            </Link>{" "}
            for more.
        ...
        <section>
          ...
          <p className="text-slate-600">
            We do not use the personal information you provide us (such as through tournament registration or the
            contact channels) to train third-party AI models. Where an AI tool processes information as part of how our
            website or internal systems function, that processing is limited to performing the requested task and is
            handled under the safeguards described in our{" "}
            <Link href="/privacy-policy" className="text-[#405862] font-medium underline hover:text-[#4ecdc4]">
              Privacy Policy
            </Link>
            .
